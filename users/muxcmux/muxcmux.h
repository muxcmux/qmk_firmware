...
#define L0R1      SC_LSPO,   CTL_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, CTL_SLS, SC_RSPC
              //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
#define L0R0                                          KC_LALT, GUI_SPC, KC_BSPC,     KC_ENT,   MO(3),   MO(4)
                                                  //`--------------------------'  `--------------------------'
...
#define L1R0                                          _______, _______, _______,    _______, _______, _______
              ...
              //,-----------------------------------------------------.                    ,-----------------------------------------------------.
#define L2R3      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      KC_PLUS, KC_LBRC, KC_RBRC, KC_MINS, XXXXXXX, CW_TOGG
              //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
#define L3R2      _______,    KC_6,    KC_7,    KC_8,    KC_9,  KC_TAB,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, XXXXXXX, XXXXXXX
              //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
#define L3R1      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX
              //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
#define L3R0                                          _______, _______, _______,    _______, _______, _______
                                                  //`--------------------------'  `--------------------------'

              //,-----------------------------------------------------.                    ,-----------------------------------------------------.
#define L4R3      XXXXXXX, RGB_TOG, RGB_VAD, RGB_VAI, RGB_MOD, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
              //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
#define L4R1      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
              //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
#define L4R0                                          _______, _______, _______,    _______, _______, _______
                                                  //`--------------------------'  `--------------------------'
